...
const SignUpPage = () => {
  ...
  return (
    <div className='h-screen flex items-center justify-center p-4 sm:p-4 md:p-8' data-theme="forest">
                  ...
                  <div className='form-control'>
                    <label className='label cursor-pointer justify-start gap-2'>
                      ...
                      <span className='text-xs leading-tight'>
                        I agree to the{" "}
                        <span className='range-primary hover:underline'>terms of services</span> and {" "}
                        <span className='range-primary hover:underline'>privacy policy</span>
                      </span>
                    </label>
                  </div>
                </div>
        ...
        <div className='hidden lg:flex w-full lg:w-1/2 bg-primary/10 items-center justify-center'>
          <div className='max-w-md p-8'>
            ...
            <div className='relative aspect-square max-w-sm mx-auto'>
              <img src="/i.png" alt="Language Collection Illustration" className='w-full h-full' />
            </div>
